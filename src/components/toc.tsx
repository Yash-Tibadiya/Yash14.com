...
export function useTOCListener(listener: ChangeListener) {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: callback is a stable useEffectEvent handler and must not be a dependency
  useEffect(() => {
