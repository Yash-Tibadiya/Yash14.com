...
/**
 * Formats an incomplete phone number string according to the metadata provided (currently IN).
 *
 ...
 *
 * @remarks
 * - Only India (IN) metadata are included. To add more countries, update the custom metadata file.
